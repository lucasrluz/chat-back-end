...
describe('Tests on the edit room route', () => {
  ...
  it('Should return error message', async () => {
    ...
    expect(editRoomResponse.status).toEqual(400);
    expect(editRoomResponse.body).toEqual('Name should not be empty');
  ...
  it('Should return error message', async () => {
    ...
    const editRoomData = new RoomWithInvalidNameType();
    ...
    expect(editRoomResponse.status).toEqual(400);
    expect(editRoomResponse.body).toEqual('Name must be a string');
